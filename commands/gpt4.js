...
module.exports = async (senderId, prompt, api, imageAttachments) => { 
    try {
        ...
        if (!prompt || prompt.trim() === '') {
            await sendMessage(senderId, "🤖✨ Bonjour! Je suis gpt 4.5, votre assistant IA. Comment puis-je vous aider aujourd'hui? Posez-moi n'importe quelle question ou partagez une image pour que je puisse l'analyser!");
            return;
        }

        // Envoyer un message d'attente stylisé
        await sendMessage(senderId, "✨🧠 Analyse en cours... Gpt 4.5 réfléchit à votre requête avec intelligence artificielle supérieure! ⏳💫");
...
module.exports.info = {
    name: "gpt4",
    description: "Discutez avec Gpt 4.5, une IA avancée capable d'analyser du texte et des images.",
    usage: "Envoyez 'gpt4 <question>' pour discuter avec Claude, ou envoyez une image suivie de questions à son sujet."
};
